...
##### 🔐 로그인 화면
![로그인 화면](docs/images/login_screen-2025-05-31T23-12-09-936Z.png)

*깔끔한 로그인 인터페이스 - 이메일/비밀번호 인증*

##### 📝 회원가입 화면
![회원가입 화면](docs/images/register_screen-2025-05-31T23-14-01-692Z.png)

*사용자 등록 폼 - 이메일, 사용자명, 비밀번호 입력*

##### 📊 대시보드 메인 화면
![대시보드 화면](docs/images/dashboard_screen-2025-05-31T23-12-32-216Z.png)

*React 기반 모던 대시보드 - 프로젝트 관리, 문서 업로드, AI 채팅 통합 인터페이스*
